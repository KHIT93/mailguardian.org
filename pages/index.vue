                    ...
                    <ul class="md:grid md:grid-cols-2 md:col-gap-8 md:row-gap-10">
                        <li>
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    <h4 class="text-lg leading-6 font-medium text-gray-900">Easy to use</h4>
                        ...
                        <li class="mt-10 md:mt-0 md:pb-10">
                            <div class="flex">
                                <div class="flex-shrink-0">
                                    <div class="flex items-center justify-center h-12 w-12 rounded-md bg-blue-500 text-white">
                                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="ml-4">
                                    <h4 class="text-lg leading-6 font-medium text-gray-900">Solid technologies</h4>
                                    <p class="mt-2 text-base leading-6 text-gray-500">
                        ...
                        <li class="mt-10 md:mt-0 md:pb-10">
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    <h4 class="text-lg leading-6 font-medium text-gray-900">RESTful API</h4>
                                    <p class="mt-2 text-base leading-6 text-gray-500">
                        ...
                        <li class="mt-10 md:mt-0 md:pb-10">
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    <h4 class="text-lg leading-6 font-medium text-gray-900">Scalable by default</h4>
                                    <p class="mt-2 text-base leading-6 text-gray-500">
                        ...
                        <li class="mt-10 md:mt-0 md:pb-10">
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    <h4 class="text-lg leading-6 font-medium text-gray-900">Multiple access levels</h4>
                                    <p class="mt-2 text-base leading-6 text-gray-500">
                        ...
                        <li class="mt-10 md:mt-0 md:pb-10">
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    <h4 class="text-lg leading-6 font-medium text-gray-900">Manage multiple systems</h4>
                                    <p class="mt-2 text-base leading-6 text-gray-500">
                        ...
                        <li class="mt-10 md:mt-0 md:pb-10">
                            <div class="flex">
                                ...
                                <div class="ml-4">
                                    <h4 class="text-lg leading-6 font-medium text-gray-900">Fully open-source</h4>
                                    <p class="mt-2 text-base leading-6 text-gray-500">
        ...
        <div class="bg-gray-50">
            <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
                <h2 class="text-3xl leading-9 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">
                    Ready to start?
                    <br>
                    <span class="text-blue-600">Start right here!</span>
                </h2>
